      ...
      <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12">
        ...
        <div className="w-full lg:w-1/2 lg:max-w-2xl">
          ...
          <h2 className="text-5xl font-bold text-primary mb-6 leading-tight">
            Enabling Business Growth with <span className="text-primary">Cloud Computing</span>
          </h2>
          ...
          <p className="text-xl text-primary leading-relaxed pl-4 border-l-4 border-secondary/40">
            Leveraging cloud solutions fosters innovation, efficiency, and scalability. <span className="text-primary font-medium">Codework</span> empowers enterprises to embrace digital transformation seamlessly. Contact us today to explore tailored cloud solutions.
          </p>
        </div>

  ...
  const benefits = [
    {
      ...
      hoverText: "Safeguard crucial business and customer information from breaches."
    },
    {
      title: "Boost Business Reputation",
      hoverText: "Strengthen trust with robust security protocols and data privacy."
    },
    {
      title: "Limit Financial Risks",
      hoverText: "Reduce losses caused by cyber threats and regulatory issues."
    },
    {
      title: "Counter Cyber Threats",
      hoverText: "Guard against hackers, malware, ransomware, and phishing attempts."
    },
    {
      title: "Meet Regulatory Standards",
      hoverText: "Comply with industry regulations like GDPR, HIPAA, SOC 2, and ISO 27001."
    }
  ];

...
import { FaShieldAlt, FaNetworkWired, FaCloud, FaLock, FaProjectDiagram, FaSearch, FaUserShield, FaGraduationCap, FaEye, FaExclamationTriangle } from "react-icons/fa";
...
export default function CybersecurityService() {
  ...
  const cards = [
    {
      title: "Cyber Risk Assessment & Security Audits",
      text: `Identify vulnerabilities and strengthen cybersecurity strategies with a detailed security assessment.`,
      Icon: FaShieldAlt,
      gradient: "from-secondary/80 to-secondary/60"
    },
    {
      title: "Network Security & Firewall Protection",
      text: `Protect business networks with next-gen firewalls, intrusion detection systems, and advanced threat prevention.`,
      Icon: FaNetworkWired,
      gradient: "from-secondary/70 to-secondary/50"
    },
    {
      title: "Protect cloud environments",
      text: `By implementing data encryption, managing access controls, and maintaining continuous security monitoring.`,
      Icon: FaCloud,
      gradient: "from-secondary/90 to-secondary/70"
    },
    {
      title: "Endpoint Security & Threat Detection",
      text: `Safeguard devices from malware, phishing, and cyber threats with real-time detection.`,
      Icon: FaLock,
      gradient: "from-secondary/85 to-secondary/65"
    },
    {
      title: "Penetration Testing & Ethical Hacking",
      text: `Conduct real-world cyberattack simulations to uncover vulnerabilities and strengthen security measures.`,
      Icon: FaSearch,
      gradient: "from-secondary/80 to-secondary/60"
    },
    {
      title: "Data Encryption & Secure Access Management",
      text: `Ensure only authorized personnel have access to sensitive data, applications, and IT infrastructure.`,
      Icon: FaUserShield,
      gradient: "from-secondary/90 to-secondary/70"
    },
    {
      title: "Ransomware Protection & Incident Response",
      text: `Detect ransomware threats early and implement incident response strategies to mitigate risks.`,
      Icon: FaExclamationTriangle,
      gradient: "from-secondary/75 to-secondary/55"
    },
    {
      title: "Compliance & Regulatory Advisory",
      text: `Stay aligned with data protection laws and avoid penalties with expert compliance solutions.`,
      Icon: FaProjectDiagram,
      gradient: "from-secondary/70 to-secondary/50"
    },
    {
      title: "Security Awareness Training",
      text: `Educate employees on cybersecurity best practices to reduce risks caused by human errors.`,
      Icon: FaGraduationCap,
      gradient: "from-secondary/85 to-secondary/65"
    },
    {
      title: "24/7 Security Monitoring & Threat Intelligence",
      text: `Continuous monitoring and real-time threat intelligence for proactive cyber defense.`,
      Icon: FaEye,
      gradient: "from-secondary/80 to-secondary/60"
    },
  ];
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-5xl font-bold text-primary mb-6">
            Comprehensive <span className="text-primary">Cybersecurity</span> Services
          </h2>

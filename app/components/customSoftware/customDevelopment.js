...
import { 
  FaCode,        // Web & Mobile App Development
  FaBuilding,    // Enterprise Software Solutions
  FaBrain,       // AI-Driven Software Development
  FaLink,        // API & System Integration
  FaSync         // Legacy System Modernization
} from 'react-icons/fa';
  ...
  const cards = [
    {
      ...
      text: `Designing high-performance web and mobile applications optimized for user engagement and functionality.`,
      Icon: FaCode,
      gradient: "from-secondary/80 to-secondary/60",
    },
    {
      title: "Enterprise Software Solutions",
      text: `Developing CRM, ERP, and HRM systems to streamline operations and boost productivity.`,
      Icon: FaBuilding,
      gradient: "from-secondary/70 to-secondary/50",
    },
    {
      title: "AI-Driven Software Development",
      text: `Integrating machine learning and predictive analytics to automate processes and enhance decision-making.`,
      Icon: FaBrain,
      gradient: "from-secondary/90 to-secondary/70",
    },
    {
      title: "API & System Integration",
      text: `Building secure APIs for seamless data exchange across business platforms.`,
      Icon: FaLink,
      gradient: "from-secondary/75 to-secondary/55",
    },
    {
      title: "Legacy System Modernization",
      text: `Upgrading outdated systems with cloud-based and AI-powered technologies for improved performance.`,
      Icon: FaSync,

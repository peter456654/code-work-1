...
import { FaClipboardList, FaPalette, FaBolt, FaRocket, FaSearch } from 'react-icons/fa';
import DevelopmentProcessCycle from './DevelopmentProcessCycle';

const steps = [
  {
    title: 'Discovery & Planning',
    description: 'Identifying and understanding business objectives.',
    Icon: FaClipboardList,
    step: '01'
  },
  {
    title: 'Prototyping & Design',
    description: 'Developing intuitive and user-friendly UI/UX designs.',
    Icon: FaPalette,
    step: '02'
  },
  {
    title: 'Agile Development',
    description: 'Adopting an iterative and scalable methodology.',
    Icon: FaBolt,
    step: '03'
  },
  {
    title: 'Deployment & Integration',
    description: 'Implementing the software seamlessly into existing systems.',
    Icon: FaRocket,
    step: '04'
  },
  {
    title: 'Support & Optimization',
    description: 'Providing ongoing improvements and enhancements.',
    Icon: FaSearch,
    step: '05'
  },
];
          ...
          <div className="flex-1 relative w-full">
            ...
            <div className="mt-8 sm:mt-12 hidden lg:block">
              <div className="flex justify-between items-center relative">
                ...
                {/* Connection Line */}
                <div className="absolute top-4 lg:top-5 left-4 lg:left-5 right-4 lg:right-5 h-0.5 bg-white/20">
                  <div

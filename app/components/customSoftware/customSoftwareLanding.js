          ...
          <div className="lg:col-span-2 text-left">
            ...
            <div className="heading-container mb-8">
              <h1 className="text-4xl sm:text-5xl lg:text-5xl font-bold text-primary leading-tight mb-6">
                <span className="text-primary">Scalable and Tailored Software</span> for Business Growth
              </h1>
            ...
            <div className="paragraph-container mb-8 max-w-3xl">
              <p className="text-lg text-primary leading-relaxed pl-4 border-l-4 border-secondary/40">
                The core of <span className="text-primary font-medium">Codework</span> is creating bespoke software solutions that perfectly align with your unique business requirements. Every project is crafted to enhance operational efficiency and drive digital transformation. Whether developing enterprise applications, web platforms, or specialized software systems, expert developers ensure scalable and innovative solutions that deliver exceptional results.
              </p>
              
              <div className="mt-6">
                <h3 className="text-lg font-semibold text-primary mb-4">Transform your business with custom software solutions built for your success.</h3>
              </div>
            </div>
          </div>

          ...
          <div className="lg:col-span-2 text-left">
            ...
            <div className="heading-container mb-8">
              <h1 className="text-4xl sm:text-5xl lg:text-5xl font-bold text-primary leading-tight mb-6">
                Scalable <span className="text-primary">DevOps Solutions</span> for Accelerated Software Delivery
              </h1>
            ...
            <div className="paragraph-container mb-8 max-w-3xl">
              <p className="text-lg text-primary leading-relaxed pl-4 border-l-4 border-secondary/40">
                The core of <span className="text-primary font-medium">Codework</span> is creating seamless DevOps pipelines that accelerate software delivery and enhance operational efficiency. Every solution is crafted to bridge development and operations teams while ensuring continuous integration and deployment. Whether implementing CI/CD pipelines, container orchestration, or infrastructure automation, expert DevOps engineers ensure scalable and reliable solutions that drive business agility.
              </p>
              
              <div className="mt-6">
                <h3 className="text-lg font-semibold text-primary mb-4">Transform your software delivery with modern DevOps practices that ensure reliability and speed.</h3>
              </div>
            </div>
          </div>
                      ...
                      <div className="relative z-10 flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          {service.dropdown && (
                            ...
                            >
                              <svg 
                                className={`w-4 h-4 transition-transform duration-200 ${openDropdown === index ? 'rotate-180' : ''} text-primary`} 
                                fill="none" 
                                viewBox="0 0 24 24" 
                                stroke="currentColor"
                              >

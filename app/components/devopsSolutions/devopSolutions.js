      ...
      <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12">
        ...
        <div className="w-full lg:w-1/2 lg:max-w-2xl">
          ...
          <h2 className="text-5xl font-bold text-primary mb-6 leading-tight">
            Transform Software Development with <span className="text-primary">DevOps</span>
          </h2>
          ...
          <p className="text-xl text-primary leading-relaxed pl-4 border-l-4 border-secondary/40">
            Adopting DevOps solutions enables automated workflows, cloud-native applications, and seamless deployments. <span className="text-primary font-medium">Codework</span> specializes in scalable, secure, high-performance DevOps strategies tailored to business needs. Explore cutting-edge DevOps consulting and implementation services to enhance operational efficiency.
          </p>
        </div>

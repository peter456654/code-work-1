            ...
            <div className="text-sm sm:text-base md:text-lg lg:text-xs xl:text-lg w-full sm:w-[95%] lg:w-full xl:w-[85%] leading-relaxed text-primary/90 space-y-2 lg:space-y-1 xl:space-y-3 relative">
              ...
              <div className="sm:pl-6">
                <p className="font-light">
                  The <span className="text-primary font-medium">healthcare industry</span> struggles with early <span className="text-primary font-medium">colon cancer detection</span> due to invasive, costly procedures like colonoscopies, leading to low compliance and delayed diagnoses.
                </p>
                            </div>
            </div>

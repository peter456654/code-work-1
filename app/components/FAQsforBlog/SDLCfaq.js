  ...
  const faqs = [
    {
      ...
      answer: [
        "SDLC is a structured framework that guides the design, development, testing, deployment, and maintenance of reliable software.",
      ],
    },
    {
      question: "What are the main phases of the SDLC?",
      answer: [
        "The phases include requirement gathering, planning, design, development, testing, deployment, and maintenance.",
      ],
    },
    {
      question: "What are the common SDLC models?",
      answer: [
        "Popular models include Waterfall, Agile, V-Model, Iterative, and Spiral—chosen based on project needs.",
      ],
    },
    {
      question: "How does DevOps fit into the SDLC?",
      answer: [
        "DevOps extends Agile by promoting CI/CD, automation, and faster feedback loops for quicker, more reliable releases.",
      ],
    },
    {
      question: "What are the benefits of using SDLC?",
      answer: [
        "It ensures higher quality software, better risk management, clear structure, improved collaboration, and predictable timelines.",
      ],
    },
  ];
